...
class ClusteringTest(unittest.TestCase):
    ...
    def test_kmeans(self):
        tss = Array.from_list([[0.0,   1.0,  2.0,  3.0],
                               [6.0,   7.0,  8.0,  9.0],
                               [2.0,  -2.0,  4.0, -4.0],
                               [8.0,   5.0,  3.0,  1.0],
                               [15.0, 10.0,  5.0,  0.0],
                               [7.0,  -7.0,  1.0, -1.0]], dtype.f32)
        ...
        result_c = result.centroids.to_numpy()
    ...
    def test_k_shape(self):
        ...
        np.testing.assert_array_almost_equal(
            centr, expected_c, decimal=self.DECIMAL)
        np.testing.assert_array_almost_equal(
            lab, expected_l, decimal=self.DECIMAL)
